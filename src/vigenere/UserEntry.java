	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
			 ...
			 System.out.println(Vignere.encrypt(textField.getText(), textField_3.getText()));
		...
		JLabel lblMonoap = new JLabel("vignere");
		...
		btnDecrypt.addMouseListener(new MouseAdapter() {
			...
			System.out.println(Vignere.decrypt(textField_1.getText(), textField_2.getText()));
		}
		...
		btnEncToFile.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					w.write(Vignere.encrypt(textField.getText(), textField_3.getText()));
					w.close();
		...
		btnDecToFile.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					FileWriter w = new FileWriter(new File("/home/s0n1c/Desktop/playfair.txt"));
					w.write( Vignere.decrypt(textField_1.getText(), textField_2.getText()));
					w.close();
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
