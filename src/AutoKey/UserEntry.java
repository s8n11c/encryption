	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
			 ...
			 System.out.println(AutoKey.encrypt(textField.getText(), textField_3.getText()));
		...
		JLabel lblMonoap = new JLabel("AutoKey");
		...
		btnDecrypt.addMouseListener(new MouseAdapter() {
			...
			System.out.println(AutoKey.decrypt(textField_1.getText(), textField_2.getText()));
		}
		...
		btnEncToFile.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					FileWriter w = new FileWriter(new File("/home/s0n1c/Desktop/autokey.txt"));
					w.write( AutoKey.encrypt(textField.getText(), textField_3.getText()));
					w.close();
		...
		btnDecToFile.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					FileWriter w = new FileWriter(new File("/home/s0n1c/Desktop/autokey.txt"));
					w.write( AutoKey.decrypt(textField_1.getText(), textField_2.getText()));
					w.close();
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
